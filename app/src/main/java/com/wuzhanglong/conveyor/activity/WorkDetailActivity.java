...
//        }
        WorkDetailVO.DataBean.ShareBean shareBean = mWorkDetailVO.getData().getShare_param();
        ToUMShare(this, shareBean.getImage(), shareBean.getTitle(), shareBean.getDesc(), shareBean.getUrl());
    }
...
//    }
    ...
    private void ToUMShare(final Activity activity, String imageUrl, String title, String description, String WebUrl) {
        ...
        new ShareAction(WorkDetailActivity.this).withText("")
                ...
                .setCallback(new UMShareListener() {
                    ...
                    public void onResult(SHARE_MEDIA share_media) {
                        Toast.makeText(WorkDetailActivity.this, "分享成功", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onError(SHARE_MEDIA share_media, Throwable throwable) {

                        Toast.makeText(WorkDetailActivity.this, "分享失败" + throwable.toString(), Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onCancel(SHARE_MEDIA share_media) {
                        Toast.makeText(WorkDetailActivity.this, "分享取消", Toast.LENGTH_SHORT).show();
                    }
                }).open();
    }
}
